...
export function Sheet({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30 px-4 py-4 sm:px-4">
      <div className="bg-white w-full sm:max-w-md rounded-2xl max-h-[92vh] overflow-y-auto">
